# Sigma Rule DSL — Specification Snapshot (`dsl_v0.4.md`)

Document ID: `dsl_v0.4`  
Status: Implemented snapshot (v0.4-A: event log + replay)  
...
This document is a **full copy-forward** of `docs/dsl_v0.3.md` with **only the referenced v0.4 chapters updated**
to reflect the implemented Sprint 0.4-A event log + replay behavior.

Updated sections in this snapshot:
- Chapter 6 (run logs + replay requirements concretized)
- Chapter 21 (CLI replay contract noted)
...
### 6.3.1 v0.4-A run log schema (self-contained snapshot)

In v0.4-A, the runner produces a **single JSON run log** with:
