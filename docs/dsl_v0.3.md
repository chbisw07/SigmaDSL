# Sigma Rule DSL — Specification Snapshot (`dsl_v0.3.md`)

Document ID: `dsl_v0.3`  
Status: Implemented snapshot (v0.3-A: deterministic evaluator + trace)  
...
This document is a **full copy-forward** of `docs/DSL_v0.md` with **only the referenced v0.3 chapters updated**
to reflect the implemented Sprint 0.3-A evaluator + trace behavior.
